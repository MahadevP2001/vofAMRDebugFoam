...
int main(int argc, char *argv[])
{
    ...
    while (runTime.run())
    {
        ...
        Foam::word currentTimeName = runTime.timeName();
        Veronika.FieldInfoWriter(currentTimeName,mesh);
        
        Info << "Hello to the comment debugging World!" << endl;
        ...
        while (pimple.loop())
        {
             ...
             */
            //Veronika.TSource(); temporary
            
            Veronika.momeqnterms();
        }
